...
for word in mostCommonWords:
	...
	for traits in allTraits:
		...
		for cWords in currentTraitsKeywords:
			...
			#if currentTraits == 'extraversion':
			#print "cWordsCoeff ", cWordsCoeff, " cosine_similarity " , cosine_similarity
...
for ab in output:
	...
	pTraitsValue = 8.0 * ( ((positiveOutput - negativeOutput)) + abs(cosSim) ) / abs(cosSim)
